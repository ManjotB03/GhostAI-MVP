...
export default function GhostClient() {
  ...
  const handleFileSelected = async (f: File | null) => {
    ...
    const allowed = lowerName.endsWith(".pdf") || lowerName.endsWith(".txt") || lowerName.endsWith(".md");

    if (!allowed) {
      setFile(null);
      setFileWarning("Unsupported file type. Please upload a PDF, TXT, or MD file.");
      return;
    }
        ...
        <div className="flex-1 flex justify-center px-4">
          ...
          >
            ...
            <div className="w-full max-w-xl mb-4">
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  {file ? (
                    ...
                    <div className="text-sm text-gray-400">
                      Drag & drop your CV here or click Attach file
                    </div>
                  )}
                </div>
              ...
              {fileWarning && (
                <div className="mt-3 text-sm bg-yellow-900/40 border border-yellow-700 text-yellow-200 p-3 rounded-lg">
                  {fileWarning}
                </div>
              )}
